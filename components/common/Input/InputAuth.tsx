...
export default function InputAuth<TFieldValues extends FieldValues = FieldValues>({
  errorMessage,
  className,
  name,
  register,
  rules,
  classNameInput = 'p-3 w-full border border-gray-400 rounded focus:shadow-sm focus:border-color-primary',
